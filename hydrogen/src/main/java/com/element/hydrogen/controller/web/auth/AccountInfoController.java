...
public class AccountInfoController {
    ...
    public ResponseJson updatePwd(HttpServerRequest request,@RequestBody DonAccountInfoEntity donAccountInfoEntity){
        ResponseJson resJson = new ResponseJson();
        donAccountInfoEntity.setOperator("molecule");
        try{
            resJson =accountInfoService.updatePwd(donAccountInfoEntity);
        }catch (Exception e){
            resJson.setCode(res.FAIL);
            resJson.setMsg(res.FAIL_UPD);
        }
