 ...
 */
@RestController
@RequestMapping("/web/graph/hlmInfo")
public class HlmInfoController {
    ...
    @CrossOrigin
    @RequestMapping(value = "/queryHlmInfo",method = RequestMethod.POST)
    public ResponseJson queryHlmInfo(@RequestBody DonHlmInfoEntity donHlmInfoEntity){
        return hlmInfoService.queryHlmInfo(donHlmInfoEntity);
    }
