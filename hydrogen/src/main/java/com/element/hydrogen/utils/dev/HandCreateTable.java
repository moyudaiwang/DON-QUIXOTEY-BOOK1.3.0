...
public class HandCreateTable {
    private  static final  String EXCEL_PATH ="D:\\TransactionFile\\堂吉诃德\\4_Tool\\CreateTable\\20250517mysql建表\\TableFile.xls";  //要读取的Excel路径
    private  static final  String SQL_PATH ="D:\\TransactionFile\\堂吉诃德\\4_Tool\\CreateTable\\20250517mysql建表\\result.sql";  //要生成的建表SQL的路径
