...
public class AutoDevUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String newBase = "treeRel"; //donNew ----目标名称（每次需要修改）
        String newModelNameBase = "树结构关系"; //donNew ----目标名称（每次需要修改）
        ...
        //读取特定目录下文件
        String oldPath = "D:\\TransactionFile\\堂吉诃德\\4_Tool\\AutoDev\\resource"; //源文件基础路径（一般不需要修改）
        String newPathBase = "D:\\TransactionFile\\堂吉诃德\\4_Tool\\AutoDev\\result"; //目标文件基础路径（一般不需要修改）
