...
public class HlmInfoServiceImpl implements HlmInfoService {
    ...
    @Override
    public ResponseJson queryHlmInfo(DonHlmInfoEntity donHlmInfoEntity) {
        ResponseJson resJson = new ResponseJson();
        PageHelper.startPage(donHlmInfoEntity.getPageNum(), donHlmInfoEntity.getPageSize());
        List<DonHlmInfoEntity> donHlmInfoEntityList = donLogInfoMapper.queryHlmInfo(donHlmInfoEntity);
