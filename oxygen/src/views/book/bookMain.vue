...
<!--    TODO 1.2.0上线前隐藏              <el-button type="primary" icon="el-icon-upload2" @click="uploadTo()">导入</el-button>
                  <el-button type="primary" icon="el-icon-download" @click="download()">导出</el-button>-->
              </div>
              <div class="right-items" style="float: right">
                <el-input placeholder="ISBN/书名/作者" v-model="param.queryName" clearable class="input-with-select"></el-input>
             ...
             <el-table-column type="expand">
               <template slot-scope="props">
                 <el-form label-position="left" inline class="demo-table-expand">
                   ...
                   <el-form-item label="作者外文名">
                     <span>{{ props.row.authorForeignName }}</span>
                   </el-form-item>
                   <el-form-item label="译者外文名">
                     <span>{{ props.row.translatorForeignName }}</span>
                   </el-form-item>
                   <el-form-item label="责任编辑">
                     <span>{{ props.row.editorCharge }}</span>
                   </el-form-item>
                   <el-form-item label="封面设计">
                     <span>{{ props.row.coverDesign }}</span>
                   </el-form-item>
                   <el-form-item label="丛书系列">
                     <span>{{ props.row.collection }}</span>
                   </el-form-item>
                   <el-form-item label="发行单位">
                     <span>{{ props.row.issue }}</span>
                   </el-form-item>
                   <el-form-item label="印装厂">
                     <span>{{ props.row.printHouse }}</span>
                   </el-form-item>
                   <el-form-item label="货币类型">
                     <span>{{ props.row.currencyType }}</span>
                   </el-form-item>
                   <el-form-item label="首版时间">
                     <span>{{ props.row.editionFirstDate }}</span>
                   </el-form-item>
                   <el-form-item label="首印时间">
                     <span>{{ props.row.impressionFirstDate }}</span>
                   </el-form-item>
                   <el-form-item label="印刷时间">
                     <span>{{ props.row.impressionDate }}</span>
                   </el-form-item>
                   <el-form-item label="版次">
                     <span>{{ props.row.edition }}</span>
                   </el-form-item>
                   <el-form-item label="印次">
                     <span>{{ props.row.impression }}</span>
                   </el-form-item>
                   <el-form-item label="印张">
                     <span>{{ props.row.sheetsNum }}</span>
                   </el-form-item>
                   <el-form-item label="开本">
                     <span>{{ props.row.bookFormat }}</span>
                   </el-form-item>
                   <el-form-item label="字数">
                     <span>{{ props.row.wordNum }}</span>
                   </el-form-item>
                   <el-form-item label="页数">
                     <span>{{ props.row.pageNum }}</span>
                   </el-form-item>
                   <el-form-item label="印量起始">
                     <span>{{ props.row.printNumStart }}</span>
                   </el-form-item>
                   <el-form-item label="印量终止">
                     <span>{{ props.row.printNumEnd }}</span>
                   </el-form-item>
                   <el-form-item label="印量">
                     <span>{{ props.row.printNum }}</span>
                   </el-form-item>
                   <el-form-item label="语言">
                     <span>{{ props.row.language }}</span>
                   </el-form-item>
                   <el-form-item label="中图法分类">
                     <span>{{ props.row.clc }}</span>
                   </el-form-item>
                   <el-form-item label="四库分类">
                     <span>{{ props.row.flc }}</span>
                   </el-form-item>
                   <el-form-item label="装帧类型">
                     <span>{{ props.row.bindType }}</span>
                   </el-form-item>
                   <el-form-item label="长宽高">
                     <span>{{ props.row.lwh }}</span>
                   </el-form-item>
                   ...
                   <el-form-item label="签名本">
                     <span>{{ props.row.signFlag }}</span>
                   </el-form-item>
                   <el-form-item label="铃印本">
                     <span>{{ props.row.signetFlag }}</span>
                   </el-form-item>
                   <el-form-item label="书像">
                     <span>{{ props.row.bookAvatar }}</span>
                   </el-form-item>
